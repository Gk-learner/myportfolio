...
//                             <Card.Body>
//                                 <Card.Title className="text-light"> Gaming Website </Card.Title>
//                                 <Card.Text>
//                                     <ul>
//                                       <li>Built responsive UI using HTML5, CSS3, React</li>
//                                         <li>Optimized website performance for faster load times</li>
//                                         <li>Collaborated with a team using Git and GitHub for version control</li>
//                                     </ul>
//                                 </Card.Text>
//                             </Card.Body>
//                         </Card>
...
//                                 <Card.Body>
//                                     <Card.Title className="text-light"> Sozentech- Corporate Website </Card.Title>
