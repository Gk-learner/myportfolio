                    ...
                    <Container ref={ref} fluid className={`animContainer ${inView ? "visible" : ""}`} id="about">
                        <Row>
                            ...
                            <motion.div
                                ...
                                // transition={{
                                //   rotate: { duration: 1.2, repeatDelay: 3 },
                            ...
                            >
                                    ...
                                    <Card className="mt-5 text-center p-4 aboutCard">
                                        <Card.Body>
                                            <Card.Text>
                                                ...
                                                Things I am excited about lately is learning new technologies. A
                                                learner, doer embracing new technologies and finding inspiration in the
                                                tech wold. My skills set includes
                                                <mark>
                                ...
                                <Col sm={6} xl={6} className="mobColRight">
